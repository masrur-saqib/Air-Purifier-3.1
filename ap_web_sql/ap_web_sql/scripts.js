...
function getTableData() {
  $.get("https://air.gizantech.com/ajax_table_data.php", function (data, status) {
...
function getCurrentData() {
  $.get("https://air.gizantech.com/ajax_curr_data.php", function (data, status) {
    jsonData = JSON.parse(data);
...
var today = new Date('August 5, 2022 15:00:01 GMT+6:00');
...
function onTimeChange(graphID) {
  ...
  date.setTime(0); //Setting the time to Zero
  ...
  $.post("https://air.gizantech.com/ajax_fetch.php", {
    date1: t1,
    date2: t2,
    graphID: graphID,
  })
