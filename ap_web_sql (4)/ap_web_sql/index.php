      ...
      <center>
        ...
        <br><br>
            <b>Updated PCB:</b>
              ...
              ESP32 has built-in wifi, reducing the need for an external wifi module. 
              Besides, it's cheaper but powerful enough. <br><br>
              ...
              Instead of using not good-looking plastic cardboard, I've used laser cut on plywood, designed on Onshape software. 
              <br><br>
              ...
              <br><br>
              <b>
                From Localhost to the World Wide Web (WWW): 
              </b>
              Anyone can access the data from anywhere in the world using the website "air.gizantech.com".
              <br><br>
              <b>
                Over the Air (OTA) support: 
              </b>
              We can update the embedded programs inside the ESP32 microcontroller without using any wired medium. We can update the hardware using WiFi.
              <br><br>
        </h4>
      </center>
    </div>
